        ...
        <section className='max-w-7xl mx-auto '>
            <div>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w-[700px] '>
                    Create collection of imaginative and visually stunning images through AI and share them with community
                </p>
            </div>

            <form className='mt-16 max-w-4xl' onSubmit={handleSumbit}>
